export const Bio = {
  ...
  github: "https://github.com/ayitharevanth",
  resume:
    "https://drive.google.com/file/d/1Oz4dUdfQGBhvKARYVw5FalWdPJpn17S1/view?usp=sharing",
  linkedin: "https://www.linkedin.com/in/revanth-ayitha-1b5308243/",
  twitter: "https://x.com/RevanthAyi71305",
  insta: "https://www.instagram.com/ayitharevanth/",
  facebook: "https://www.facebook.com/profile.php?id=100095512711595",
};
...
export const experiences = [
  {
    ...
    desc: "Worked on building AI models to solve real-world problems, focusing on model accuracy, optimization, and deployment. Actively participated in project discussions and presented solutions to peers and mentors.",
    skills: ["Artificial Intelligence", "Machine Learning"],
    doc: "https://example.com/infosys_project_report.pdf" // Replace with actual document URL
  },
  {
    id: 1,
    ...
    desc: "Helped in developing the front end of Lawcrats’ web platform, focusing on user interface design and responsiveness. Participated in tech reviews and worked closely with the team to follow best practices in frontend development.",
    skills: ["HTML", "CSS", "JavaScript", "React"],
    doc: "https://example.com/law_crats_project_report.pdf" // Replace with actual document URL
  }
];
// export const experiences = [
//   {
...
export const projects = [
  {
    ...
    date: "Recent",
    description:
      "Developed and deployed a fully functional e-commerce website using the MERN stack. Created visually appealing and mobile-responsive layouts using HTML, CSS, and React.js. Integrated secure payment processing using Stripe API and implemented real-time order tracking. Designed a seamless user experience currently used by over 100+ users for online purchases. Optimized backend APIs to handle order processing and ensure data security and scalability. Enhanced user retention with real-time messaging features powered by Socket.io.",
    tags: [
      "React.js", 
      "Redux.js", 
      "Node.js", 
    ...
    category: "web app",
    github: "https://github.com/ayitharevanth/Eshop-Multi-Vendor-E-commere-Webiste-", // Note: Add actual GitHub link if available
    webapp: "https://revashop.netlify.app/", // Add live demo link if available
  },
  {
    id: 2,
    ...
    date: "Recent",
    description:
      "Built a comprehensive job board platform with authentication, candidate dashboards, and employer functionalities. Designed responsive user interfaces with React.js and styled components. Ensured secure handling of user data and optimized API responses for better performance. Integrated email notification systems and ensured mobile responsiveness across all devices.",
    tags: [
      "React.js",
      "Node.js", 
      "MongoDB", 
    ...
    category: "web app",
    github: "https://github.com/ayitharevanth", // Note: Add actual GitHub link if available
